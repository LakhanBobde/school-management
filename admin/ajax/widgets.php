    ...
    <div class="content-wrapper">
							...
							<div class="card">
								<div class="card-body">
									...
									<div class="wrapper d-flex align-items-center py-2 border-bottom">
										<img class="img-sm rounded-circle" src="<?php echo $url ?>/images/faces/face5.jpg" alt="profile">
									...
									<div class="wrapper d-flex align-items-center py-2 border-bottom">
										<img class="img-sm rounded-circle" src="<?php echo $url ?>/images/faces/face6.jpg" alt="profile">
										<div class="wrapper ml-3">
									...
									<div class="wrapper d-flex align-items-center py-2 border-bottom">
										<img class="img-sm rounded-circle" src="<?php echo $url ?>/images/faces/face7.jpg" alt="profile">
										<div class="wrapper ml-3">
									...
									<div class="wrapper d-flex align-items-center py-2 border-bottom">
										<img class="img-sm rounded-circle" src="<?php echo $url ?>/images/faces/face8.jpg" alt="profile">
										<div class="wrapper ml-3">
									...
									<div class="wrapper d-flex align-items-center py-2 mb-4">
										<img class="img-sm rounded-circle" src="<?php echo $url ?>/images/faces/face9.jpg" alt="profile">
										<div class="wrapper ml-3">
            ...
            <div class="col-md-4 grid-margin stretch-card">
							<div class="card text-center">
								<div class="card-body">
									<img src="<?php echo $url ?>/images/faces/face5.jpg" class="img-lg rounded-circle mb-2"/>
									<h4>Maria Johnson</h4>
